...
bool tk_timer_init(struct tk_timer *timer, void (*timeout_callback)(struct tk_timer *timer))
{
    ...
    return _tk_timer_insert_node_to_list(timer);
}
...
bool tk_timer_start(struct tk_timer *timer, tk_timer_mode mode, uint32_t delay_tick)
{
    ...
    return _tk_timer_set_start_param(timer);
}
...
static uint32_t get_timer_tick(void)
{
    return timer_tick;
}
...
{
    return tk_timer_loop_handler();
}

int soft_timer_register(struct tk_timer *timer, void (*timeout_callback)(struct tk_timer *timer))
{
    return tk_timer_init(timer, timeout_callback);
}

int soft_timer_start(struct tk_timer *timer, tk_timer_mode mode, uint32_t delay_tick)
{
    return tk_timer_start(timer, mode, delay_tick);
}

int soft_timer_stop(struct tk_timer *timer)
{
    return tk_timer_stop(timer);
}

// int soft_timer_delect(struct tk_timer *timer)
// {
//     return tk_timer_detach(timer);
// }
