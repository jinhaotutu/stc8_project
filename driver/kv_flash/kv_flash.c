...
/* Functions ------------------------------------------------------------------*/
static int _flash_write(unsigned long addr, unsigned long len, unsigned char *buf);
static int _flash_read(unsigned long addr, unsigned long len, unsigned char *buf);
static int _flash_sector_erase(unsigned long addr);
